...
\bibitem{ref1} Métodos de petición HTTP. (s/f). MDN Web Docs. Recuperado el 23 de septiembre de 2025, de \url{https://developer.mozilla.org/es/docs/Web/HTTP/Reference/Methods}
