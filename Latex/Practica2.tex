...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Imagenes/NODOCS.png}
\end{figure}
Debemos aclarar que no basta con poner la url \url{http://127.0.0.1:8000}, ya que de hacer esto, saltara un error bajo el nombre de detail.
Y se refiere a que FastAPI no sabe que operacion ejecutar con esa direccion y por eso respondera NOT\_FOUND.

\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Imagenes/DOCS.png}
\end{figure}
